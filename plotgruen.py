...
U1,I1= np.genfromtxt('gruen.txt', unpack= True, skip_header=1, skip_footer=12)
U2,I2= np.genfromtxt('gruen.txt', unpack= True, skip_header=24)
U3,I3= np.genfromtxt('gruen2.txt', unpack= True, skip_header=1, skip_footer=0)
def g(x,a,b):
    return a*x+b
...
xx= np.linspace(-0.9,0.7,100)
xaxis=np.linspace(-2,2,10)

print('ua',ua)
print('ub',ub)
plt.plot(-0.693,0,'xg',linewidth = 2, label = r'$U_{\mathrm{g}}$', alpha=1)
...
plt.savefig('build/plotgruen.pdf', bbox_inches = "tight")
plt.clf() 